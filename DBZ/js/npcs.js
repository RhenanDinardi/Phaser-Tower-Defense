...
function CreateNpcs (_game, _elementsNpcs, _map, _groups, _groupCollideNpcs, _tileSize ){

    this.game = _game;
    this.elementsNpcs = _elementsNpcs;
    this.spriteSheet = _map.spriteSheet;
    this.groups = _groups;
    this.groupCollideNpcs = _groupCollideNpcs;
...
CreateNpcs.prototype.addProperties = function (properties){
    ...
    if (properties.hasOwnProperty('weapon')) {
        this.enemy[properties.id].weapon = new Weapon.SingleBullet(this.game);
    }
    ...
    this.enemy[properties.id].interactive = properties.group;
...
CreateNpcs.prototype.walkNpcs = function __walkNpcs(){
    ...
    this.npcsNames.forEach(function(name){
